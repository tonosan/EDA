...
par(mfrow=c(2,2))#Setting the multiple plot canavas
...
#topright plot
plot(Voltage~datetime,data=data,type="l",xaxt="n")
axis(1,at=tickmarks,labels=c("Thu","Fri","Sat"))
#bottomleft plot
...
legend("topright",
       ...
       lty = 1,bty="n",col = c("black","red","blue"),cex = 0.8)
#bottomright plot
plot(Global_reactive_power~datetime,data=data,type="l",xaxt="n")
axis(1,at=tickmarks,labels=c("Thu","Fri","Sat"))
dev.off()
